...
function createBaseGenesisState(): GenesisState {
  return { params: undefined, portId: "", hostZoneList: [], epochTrackerList: [] };
}
...
export const GenesisState = {
  ...
  fromJSON(object: any): GenesisState {
    return {
      ...
      hostZoneList: gt.Array.isArray(object?.hostZoneList)
        ? object.hostZoneList.map((e: any) => HostZone.fromJSON(e))
        : [],
      epochTrackerList: gt.Array.isArray(object?.epochTrackerList)
  ...
  toJSON(message: GenesisState): unknown {
    ...
    if (message.hostZoneList?.length) {
      obj.hostZoneList = message.hostZoneList.map((e) => HostZone.toJSON(e));
    }
    if (message.epochTrackerList?.length) {
      obj.epochTrackerList = message.epochTrackerList.map((e) => EpochTracker.toJSON(e));
    }
    return obj;
  },
